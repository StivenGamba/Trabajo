...
var ss = SpreadsheetApp.openById('1JdUik4olPlYTFP_lVWyIZjGbdKB1uO9KZ4uzJzIsXCo');
...
// Imprimir las filas en la hoja
for (var l = 0; l < filasParaImprimir.length; l++) {
  var filaPrint = filasParaImprimir[l];
  hojaDestino.getRange(filaInicio + l, columnaInicio, 1, filaPrint.length).setValues([filaPrint]);
}
